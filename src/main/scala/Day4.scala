...
object Day4 extends App {
  ...
  val ps = new PassportScanner
  println(ps.count())

  val aps = new AdvancedPassportScanner
  println(aps.count())
...
class PassportScanner extends InputLoader(4) {
...
class AdvancedPassportScanner extends PassportScanner {
